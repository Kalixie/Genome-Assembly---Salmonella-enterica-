...
![Image1](https://github.com/Kalixie/Genome-Assembly---Salmonella-enterica-/blob/main/Visualizations/Figure1PRO.png)

##### Figure 1: Circular visualization of the assembled Salmonella enterica genome generated using Proksee. The assembly spans approximately 5 Mbp, consistent with the expected genome size for Salmonella enterica. Contig boundaries alternating in blue are shown, indicating a largely contiguous assembly.
...
Xu, X., Shi, H., Gong, X., Chen, P., Gao, Y., Zhang, X., & Xiang, S. (2020). Structural insights into sodium transport by the oxaloacetate decarboxylase sodium pump. eLife, 9, e53853. https://doi.org/10.7554/eLife.53853
